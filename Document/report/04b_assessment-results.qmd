...
The changes in retrospective runs corresponds to pattern observed in the fisheries mean age data time series (@fig-trawl-mean-caal through @fig-ashop-mean-caal), where all sources of age data from different fleets show the consistent pattern of decreasing mean age from 2022 to 2023, and an increase in 2024. 
