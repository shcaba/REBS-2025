...
The absolute size of `r Spp_short` populations are highly uncertain. `r Spp_short` is relatively lightly exploited stock, most likely because `r Spp_short` is associated with steep slopes and boulder habitats, difficult to access with bottom trawl gears. Plus, it occurs in the northern part of the assessed area (off Oregon and Washington), and is only rarely taken by fisheries in California. Given this relatively light exploitation, we did not observe large contrasts in the stock dynamics. Such contrasts between periods of depletion, followed by recovery (a.k.a. “two-way trips”) provide more about carrying capacity, the intrinsic growth rate as well as scale of the population. The more the uncertainty in the current stock status includes unfished or larger status values, the uncertainty in the scale increases greatly. This can be seem by reducing the male $M$ value down to 0.033, which 
