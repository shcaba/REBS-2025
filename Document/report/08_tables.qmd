...
#these lines were used to divide the ssb to make it trillions, now it is, so we don't need this code anymore
#spawning <- df |>
...
df |>
  ...
  gt::cols_width(
    1 ~ px(75),       
    2 ~ px(270),      # second column: WIDER for long text
    everything() ~ px(75)  
  ) |>
  gt::as_latex()
...
colnames(life_history_sens) <-   c("Label", "Type", "Reference", "Est male M", "Fixed M 2013", "Lorenzen M", "Fixed growth ext", "Prop fecund", "Fxn mat age", "Fxn mat Bspot", "Fxn mat Reye", "Biological mat")
...
```{r}
#| label: tbl-sensitivities-sel-rec_1
#| echo: false
#| message: false
#| warning: false
#| results: "asis"
#| tbl-cap: "Likelihood values and estimates of key parameters and derived quantities from each recruitment and selectivity sensitivity (recruitment deviations)."
#| tbl-pos: H
...
colnames(sel_rec_sens) <- c("Label", "Type", "Reference", "No recdevs", "1920 recdevs", "1930 recdevs", "1940 recdevs", "1950 recdevs", "1960 recdevs", "1970 recdevs", "1980 recdevs", "Logistic fisheries", "Logistic btrawl", "Logistic nontrawl")
...
```{r}
#| label: tbl-sensitivities-sel-rec_2
#| echo: false
#| message: false
#| warning: false
#| results: "asis"
#| tbl-cap: "Likelihood values and estimates of key parameters and derived quantities from each recruitment and selectivity sensitivity (recruitment deviations and fishery selectivity)."
#| tbl-pos: H
...
# ---- TABLE 1 ----
table_2 <- df |> dplyr::select(1:3, 10:14)
